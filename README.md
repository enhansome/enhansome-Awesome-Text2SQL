...
* (2025-TKDE, CCF-A) A Survey of Text-to-SQL in the Era of LLMs: Where are we, and where are we going?
  ...
  \[[code](https://github.com/HKUSTDial/NL2SQL_Handbook) ⭐ 1,563 | 🐛 0 | 🌐 Python | 📅 2026-07-28]
...
* (2023-arXiv, None) Can LLM Already Serve as A Database Interface? A BIg Bench for Large-Scale Database Grounded Text-to-SQLs
  ...
  \[[code](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main/bird) ⭐ 1,576 | 🐛 79 | 🌐 Python | 📅 2026-06-10]
...
* (2022-EMNLP, CCF-B) **STAR**: SQL Guided Pre-Training for Context-dependent Text-to-SQL Parsing
  ...
  \[[code](https://github.com/alibabaresearch/damo-convai) ⭐ 1,576 | 🐛 79 | 🌐 Python | 📅 2026-06-10]
...
* Llama \[[paper](https://arxiv.org/pdf/2302.13971.pdf)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,556 | 🐛 530 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
  * 2023/02, Meta AI proposes the open source LLM Llama, which has four scales: 7b, 13b, 33b, and 65b.

* Llama 2 \[[paper](https://ai.meta.com/research/publications/llama-2-open-foundation-and-fine-tuned-chat-models/)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,556 | 🐛 530 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
...
* ChatGLM \[[paper](https://arxiv.org/pdf/2103.10360.pdf)] \[[code](https://github.com/THUDM/ChatGLM-6B/blob/main/README.md) ⭐ 40,989 | 🐛 607 | 🌐 Python | 📅 2024-06-27] \[[model](https://huggingface.co/THUDM/chatglm-6b)]
  * 2023/03, Tsinghua University proposes the open bilingual language model ChatGLM, based on [General Language Model](https://github.com/THUDM/GLM) ⭐ 3,640 | 🐛 120 | 🌐 Python | 📅 2023-11-03 framework, with the specification of 7b.
...
* Qwen-1.5-110B \[[paper](https://qwenlm.github.io/blog/qwen1.5-110b/)] \[[code](https://github.com/QwenLM/Qwen1.5) ⭐ 27,512 | 🐛 65 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen/Qwen1.5-110B)]
...
* Qwen2 \[[paper](https://qwenlm.github.io/blog/qwen2/)] \[[code](https://github.com/QwenLM/Qwen2) ⭐ 27,512 | 🐛 65 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/collections/Qwen/qwen2-6659360b33528ced941e557f)]
...
* Qwen2.5 \[[paper](https://arxiv.org/abs/2407.10671)] \[[code](https://github.com/QwenLM/Qwen2.5) ⭐ 27,512 | 🐛 65 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen)]
...
* Qwen \[[paper](https://qianwen-res.oss-cn-beijing.aliyuncs.com/QWEN_TECHNICAL_REPORT.pdf)] \[[code](https://github.com/QwenLM/Qwen) ⭐ 21,596 | 🐛 43 | 🌐 Python | 📅 2026-03-05] \[[model](https://huggingface.co/Qwen)]
...
* ChatGLM2\[[paper](https://arxiv.org/pdf/2210.02414.pdf)] \[[code](https://github.com/THUDM/ChatGLM2-6B/blob/main/README_EN.md) ⭐ 15,529 | 🐛 450 | 🌐 Python | 📅 2024-06-27] \[[model](https://huggingface.co/THUDM/chatglm2-6b)]
...
* MiniCPM \[[paper](https://shengdinghu.notion.site/MiniCPM-c805a17c5c8046398914e47f0542095a)]
  \[[code](https://github.com/OpenBMB/MiniCPM) ⭐ 10,176 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-07-27]
...
* Deepseek \[[paper](https://arxiv.org/pdf/2401.02954.pdf)]
  \[[code](https://github.com/deepseek-ai/DeepSeek-LLM) ⭐ 7,239 | 🐛 58 | 🌐 Makefile | 📅 2024-02-04]
...
* Baichuan-13b \[[code](https://github.com/baichuan-inc/Baichuan-13B) ⭐ 2,928 | 🐛 96 | 🌐 Python | 📅 2023-09-06] \[[model](https://huggingface.co/baichuan-inc/Baichuan-13B-Base)]
...
* LoRA \[[paper](https://arxiv.org/pdf/2106.09685.pdf)] \[[code](https://github.com/microsoft/LoRA) ⭐ 13,739 | 🐛 113 | 🌐 Python | 📅 2024-12-17]
...
* BIRD-SQL \[[paper](https://arxiv.org/pdf/2305.03111.pdf)] \[[code](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main/bird) ⭐ 1,576 | 🐛 79 | 🌐 Python | 📅 2026-06-10] \[[dataset](https://bird-bench.github.io/)]
...
* Spider 2.0 \[[paper](https://spider2-sql.github.io/)] \[[code](https://github.com/xlang-ai/Spider2) ⭐ 853 | 🐛 118 | 🌐 HTML | 📅 2026-08-12] \[[dataset](https://github.com/xlang-ai/Spider2) ⭐ 853 | 🐛 118 | 🌐 HTML | 📅 2026-08-12]
...
* [QueryWeaver](https://github.com/FalkorDB/QueryWeaver) ⭐ 1,064 | 🐛 70 | 🌐 Python | 📅 2026-08-16
...
* [LLaMA-Efficient-Tuning](https://github.com/hiyouga/LLaMA-Efficient-Tuning) ⭐ 74,139 | 🐛 1,113 | 🌐 Python | 📅 2026-08-13
  [![GitHub Repo stars](https://img.shields.io/github/stars/hiyouga/LLaMA-Efficient-Tuning?style=social)](https://github.com/hiyouga/LLaMA-Efficient-Tuning/stargazers) ⭐ 74,139 | 🐛 1,113 | 🌐 Python | 📅 2026-08-13
...
* [Awesome-AIGC-Tutorials](https://github.com/luban-agi/Awesome-AIGC-Tutorials) ⭐ 4,531 | 🐛 10 | 📅 2024-03-31
  [![GitHub Repo stars](https://img.shields.io/github/stars/luban-agi/Awesome-AIGC-Tutorials?style=social)](https://github.com/luban-agi/Awesome-AIGC-Tutorials/stargazers) ⭐ 4,531 | 🐛 10 | 📅 2024-03-31
