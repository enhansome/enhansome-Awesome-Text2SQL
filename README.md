...
* (2025-TKDE, CCF-A) A Survey of Text-to-SQL in the Era of LLMs: Where are we, and where are we going?
  ...
  \[[code](https://github.com/HKUSTDial/NL2SQL_Handbook) ⭐ 1,599 | 🐛 0 | 🌐 Python | 📅 2026-08-31]
...
* (2024-arXiv, None) **DB-GPT-Hub**: Towards Open Benchmarking Text-to-SQL Empowered by Large Language Models
  ...
  \[[code](https://github.com/eosphoros-ai/DB-GPT-Hub) ⭐ 2,015 | 🐛 73 | 🌐 Python | 📅 2025-07-02]
...
* (2025-EDBT, CCF-B) **DBCᴏᴘɪʟᴏᴛ**: Natural Language Querying over Massive Databases via Schema Routing
  ...
  \[[code](https://github.com/tshu-w/DBCopilot) ⭐ 138 | 🐛 4 | 🌐 Python | 📅 2025-08-25]
  [![](https://img.shields.io/badge/Spider-green)](https://yale-lily.github.io/spider)
  [![](https://img.shields.io/badge/Spider--Realistic-yellow)](https://aclanthology.org/2021.naacl-main.105.pdf)
...
* Llama \[[paper](https://arxiv.org/pdf/2302.13971.pdf)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,622 | 🐛 533 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
  * 2023/02, Meta AI proposes the open source LLM Llama, which has four scales: 7b, 13b, 33b, and 65b.

* Llama 2 \[[paper](https://ai.meta.com/research/publications/llama-2-open-foundation-and-fine-tuned-chat-models/)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,622 | 🐛 533 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
...
* ChatGLM \[[paper](https://arxiv.org/pdf/2103.10360.pdf)] \[[code](https://github.com/THUDM/ChatGLM-6B/blob/main/README.md) ⭐ 40,948 | 🐛 605 | 🌐 Python | 📅 2024-06-27] \[[model](https://huggingface.co/THUDM/chatglm-6b)]
  * 2023/03, Tsinghua University proposes the open bilingual language model ChatGLM, based on [General Language Model](https://github.com/THUDM/GLM) ⭐ 3,679 | 🐛 119 | 🌐 Python | 📅 2023-11-03 framework, with the specification of 7b.

* Vicuna \[[paper](https://lmsys.org/blog/2023-03-30-vicuna/)] \[[code](https://github.com/lm-sys/FastChat) ⭐ 39,549 | 🐛 1,042 | 🌐 Python | 📅 2026-05-01] \[[model](https://huggingface.co/lmsys)]
...
* Alpaca \[[paper](https://crfm.stanford.edu/2023/03/13/alpaca.html)] \[[code](https://github.com/tatsu-lab/stanford_alpaca) ⭐ 30,230 | 🐛 187 | 🌐 Python | 📅 2024-07-17] \[[model](https://huggingface.co/tatsu-lab/alpaca-7b-wdiff/tree/main)]
...
* Qwen-1.5-110B \[[paper](https://qwenlm.github.io/blog/qwen1.5-110b/)] \[[code](https://github.com/QwenLM/Qwen1.5) ⭐ 27,656 | 🐛 68 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen/Qwen1.5-110B)]
...
* Qwen2 \[[paper](https://qwenlm.github.io/blog/qwen2/)] \[[code](https://github.com/QwenLM/Qwen2) ⭐ 27,656 | 🐛 68 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/collections/Qwen/qwen2-6659360b33528ced941e557f)]
...
* Qwen2.5 \[[paper](https://arxiv.org/abs/2407.10671)] \[[code](https://github.com/QwenLM/Qwen2.5) ⭐ 27,656 | 🐛 68 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen)]
...
* Qwen \[[paper](https://qianwen-res.oss-cn-beijing.aliyuncs.com/QWEN_TECHNICAL_REPORT.pdf)] \[[code](https://github.com/QwenLM/Qwen) ⭐ 21,834 | 🐛 45 | 🌐 Python | 📅 2026-03-05] \[[model](https://huggingface.co/Qwen)]
...
* ChatGLM2\[[paper](https://arxiv.org/pdf/2210.02414.pdf)] \[[code](https://github.com/THUDM/ChatGLM2-6B/blob/main/README_EN.md) ⭐ 15,513 | 🐛 450 | 🌐 Python | 📅 2024-06-27] \[[model](https://huggingface.co/THUDM/chatglm2-6b)]
...
* MiniCPM \[[paper](https://shengdinghu.notion.site/MiniCPM-c805a17c5c8046398914e47f0542095a)]
  \[[code](https://github.com/OpenBMB/MiniCPM) ⭐ 11,229 | 🐛 18 | 🌐 Jupyter Notebook | 📅 2026-09-21]
...
* WizardLM \[[paper](https://arxiv.org/pdf/2304.12244.pdf)] \[[code](https://github.com/nlpxucan/WizardLM) ⭐ 9,480 | 🐛 169 | 🌐 Python | 📅 2025-06-07] \[[model](https://huggingface.co/WizardLM)]
...
* Deepseek \[[paper](https://arxiv.org/pdf/2401.02954.pdf)]
  \[[code](https://github.com/deepseek-ai/DeepSeek-LLM) ⭐ 7,257 | 🐛 61 | 🌐 Makefile | 📅 2024-02-04]
...
* LoRA \[[paper](https://arxiv.org/pdf/2106.09685.pdf)] \[[code](https://github.com/microsoft/LoRA) ⭐ 13,811 | 🐛 114 | 🌐 Python | 📅 2024-12-17]
  * 2021/06, Microsoft proposes the Low-Rank Adaptation method for fine-tuning LLM by freezing the pre-training weights.

* QLoRA \[[paper](https://arxiv.org/pdf/2305.14314.pdf)] \[[code](https://github.com/artidoro/qlora) ⭐ 11,021 | 🐛 207 | 🌐 Jupyter Notebook | 📅 2024-06-10]
...
* RLHF \[[paper](https://huggingface.co/blog/rlhf)] \[[code](https://github.com/huggingface/blog/blob/main/zh/rlhf.md) ⭐ 3,532 | 🐛 248 | 🌐 Jupyter Notebook | 📅 2026-09-23]
...
* Spider 2.0 \[[paper](https://spider2-sql.github.io/)] \[[code](https://github.com/xlang-ai/Spider2) ⭐ 873 | 🐛 137 | 🌐 HTML | 📅 2026-08-12] \[[dataset](https://github.com/xlang-ai/Spider2) ⭐ 873 | 🐛 137 | 🌐 HTML | 📅 2026-08-12]
...
* [QueryWeaver](https://github.com/FalkorDB/QueryWeaver) ⭐ 1,080 | 🐛 48 | 🌐 Python | 📅 2026-09-23
...
* [LLaMA-Efficient-Tuning](https://github.com/hiyouga/LLaMA-Efficient-Tuning) ⭐ 74,993 | 🐛 1,156 | 🌐 Python | 📅 2026-09-14
  [![GitHub Repo stars](https://img.shields.io/github/stars/hiyouga/LLaMA-Efficient-Tuning?style=social)](https://github.com/hiyouga/LLaMA-Efficient-Tuning/stargazers) ⭐ 74,993 | 🐛 1,156 | 🌐 Python | 📅 2026-09-14
...
* [DB-GPT-Hub](https://github.com/eosphoros-ai/DB-GPT-Hub) ⭐ 2,015 | 🐛 73 | 🌐 Python | 📅 2025-07-02
  [![GitHub Repo stars](https://img.shields.io/github/stars/eosphoros-ai/DB-GPT-Hub?style=social)](https://github.com/eosphoros-ai/DB-GPT-Hub/stargazers) ⭐ 2,015 | 🐛 73 | 🌐 Python | 📅 2025-07-02
