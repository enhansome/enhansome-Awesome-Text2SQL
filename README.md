...
[![GitHub Repo stars](https://img.shields.io/github/stars/eosphoros-ai/Awesome-Text2SQL?style=social)](https://github.com/eosphoros-ai/Awesome-Text2SQL/) ⭐ 3,751 | 🐛 6 | 📅 2026-01-26
[![GitHub Repo forks](https://img.shields.io/github/forks/eosphoros-ai/Awesome-Text2SQL?style=social)](https://github.com/eosphoros-ai/Awesome-Text2SQL/) ⭐ 3,751 | 🐛 6 | 📅 2026-01-26
[![Awesome](https://img.shields.io/badge/Awesome-green.svg)](https://github.com/eosphoros-ai/Awesome-Text2SQL/) ⭐ 3,751 | 🐛 6 | 📅 2026-01-26
...
* (2025-TKDE, CCF-A) A Survey of Text-to-SQL in the Era of LLMs: Where are we, and where are we going?
  ...
  \[[code](https://github.com/HKUSTDial/NL2SQL_Handbook) ⭐ 1,584 | 🐛 0 | 🌐 Python | 📅 2026-08-31]
...
* (2025-TKDE, CCF-A) Next-Generation Database Interfaces: A Survey of LLM-based Text-to-SQL
  ...
  \[[code](https://github.com/DEEP-PolyU/Awesome-LLM-based-Text2SQL) ⭐ 1,362 | 🐛 0 | 📅 2026-08-03]
...
* (2023-arXiv, None) Can LLM Already Serve as A Database Interface? A BIg Bench for Large-Scale Database Grounded Text-to-SQLs
  ...
  \[[code](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main/bird) ⭐ 1,594 | 🐛 80 | 🌐 Python | 📅 2026-06-10]
...
* (2022-EMNLP, CCF-B) **STAR**: SQL Guided Pre-Training for Context-dependent Text-to-SQL Parsing
  ...
  \[[code](https://github.com/alibabaresearch/damo-convai) ⭐ 1,594 | 🐛 80 | 🌐 Python | 📅 2026-06-10]
...
* (2021-ICLR, CCF-A) **SCORE**: Pre-training for Context Representation in Conversational Semantic Parsing
  ...
  [![](https://img.shields.io/badge/SParC-green)](https://arxiv.org/pdf/1906.02285.pdf)
  [![](https://img.shields.io/badge/CoSQL-yellow)](https://arxiv.org/pdf/1909.05378.pdf)
  [![](https://img.shields.io/badge/MWoZ-blue)](https://github.com/budzianowski/multiwoz) ⭐ 958 | 🐛 21 | 🌐 Python | 📅 2026-04-18
...
* (2025-ACL, CCF-A) **MAC-SQL**: A Multi-Agent Collaborative Framework for Text-to-SQL
  ...
  \[[code](https://github.com/wbbeyourself/MAC-SQL) ⭐ 347 | 🐛 5 | 🌐 Python | 📅 2025-02-27]
  [![](https://img.shields.io/badge/Spider-green)](https://yale-lily.github.io/spider)
  [![](https://img.shields.io/badge/BIRD-yellow)](https://bird-bench.github.io/)
...
* Llama \[[paper](https://arxiv.org/pdf/2302.13971.pdf)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,595 | 🐛 531 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
  * 2023/02, Meta AI proposes the open source LLM Llama, which has four scales: 7b, 13b, 33b, and 65b.

* Llama 2 \[[paper](https://ai.meta.com/research/publications/llama-2-open-foundation-and-fine-tuned-chat-models/)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,595 | 🐛 531 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
...
* ChatGLM \[[paper](https://arxiv.org/pdf/2103.10360.pdf)] \[[code](https://github.com/THUDM/ChatGLM-6B/blob/main/README.md) ⭐ 40,974 | 🐛 605 | 🌐 Python | 📅 2024-06-27] \[[model](https://huggingface.co/THUDM/chatglm-6b)]
  * 2023/03, Tsinghua University proposes the open bilingual language model ChatGLM, based on [General Language Model](https://github.com/THUDM/GLM) ⭐ 3,669 | 🐛 119 | 🌐 Python | 📅 2023-11-03 framework, with the specification of 7b.

* Vicuna \[[paper](https://lmsys.org/blog/2023-03-30-vicuna/)] \[[code](https://github.com/lm-sys/FastChat) ⭐ 39,528 | 🐛 1,045 | 🌐 Python | 📅 2026-05-01] \[[model](https://huggingface.co/lmsys)]
...
* Alpaca \[[paper](https://crfm.stanford.edu/2023/03/13/alpaca.html)] \[[code](https://github.com/tatsu-lab/stanford_alpaca) ⭐ 30,236 | 🐛 186 | 🌐 Python | 📅 2024-07-17] \[[model](https://huggingface.co/tatsu-lab/alpaca-7b-wdiff/tree/main)]
...
* Qwen-1.5-110B \[[paper](https://qwenlm.github.io/blog/qwen1.5-110b/)] \[[code](https://github.com/QwenLM/Qwen1.5) ⭐ 27,594 | 🐛 67 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen/Qwen1.5-110B)]
...
* Qwen2 \[[paper](https://qwenlm.github.io/blog/qwen2/)] \[[code](https://github.com/QwenLM/Qwen2) ⭐ 27,594 | 🐛 67 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/collections/Qwen/qwen2-6659360b33528ced941e557f)]
...
* Qwen2.5 \[[paper](https://arxiv.org/abs/2407.10671)] \[[code](https://github.com/QwenLM/Qwen2.5) ⭐ 27,594 | 🐛 67 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen)]
...
* Qwen \[[paper](https://qianwen-res.oss-cn-beijing.aliyuncs.com/QWEN_TECHNICAL_REPORT.pdf)] \[[code](https://github.com/QwenLM/Qwen) ⭐ 21,701 | 🐛 42 | 🌐 Python | 📅 2026-03-05] \[[model](https://huggingface.co/Qwen)]
...
* ChatGLM2\[[paper](https://arxiv.org/pdf/2210.02414.pdf)] \[[code](https://github.com/THUDM/ChatGLM2-6B/blob/main/README_EN.md) ⭐ 15,521 | 🐛 450 | 🌐 Python | 📅 2024-06-27] \[[model](https://huggingface.co/THUDM/chatglm2-6b)]
...
* MiniCPM \[[paper](https://shengdinghu.notion.site/MiniCPM-c805a17c5c8046398914e47f0542095a)]
  \[[code](https://github.com/OpenBMB/MiniCPM) ⭐ 10,329 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-09-07]
...
* WizardLM \[[paper](https://arxiv.org/pdf/2304.12244.pdf)] \[[code](https://github.com/nlpxucan/WizardLM) ⭐ 9,481 | 🐛 169 | 🌐 Python | 📅 2025-06-07] \[[model](https://huggingface.co/WizardLM)]
...
* Deepseek \[[paper](https://arxiv.org/pdf/2401.02954.pdf)]
  \[[code](https://github.com/deepseek-ai/DeepSeek-LLM) ⭐ 7,260 | 🐛 58 | 🌐 Makefile | 📅 2024-02-04]
...
* Baichuan-7b \[[code](https://github.com/baichuan-inc/baichuan-7B) ⭐ 5,650 | 🐛 88 | 🌐 Python | 📅 2024-07-18] \[[model](https://huggingface.co/baichuan-inc/Baichuan-7B)]
...
* InternLM \[[paper](https://github.com/InternLM/InternLM-techreport/blob/main/InternLM.pdf) ⭐ 893 | 🐛 6 | 📅 2023-06-07] \[[code](https://github.com/InternLM/InternLM/) ⭐ 7,275 | 🐛 8 | 🌐 Python | 📅 2025-10-30] \[[model](https://huggingface.co/internlm)]
...
* LoRA \[[paper](https://arxiv.org/pdf/2106.09685.pdf)] \[[code](https://github.com/microsoft/LoRA) ⭐ 13,779 | 🐛 114 | 🌐 Python | 📅 2024-12-17]
  * 2021/06, Microsoft proposes the Low-Rank Adaptation method for fine-tuning LLM by freezing the pre-training weights.

* QLoRA \[[paper](https://arxiv.org/pdf/2305.14314.pdf)] \[[code](https://github.com/artidoro/qlora) ⭐ 11,009 | 🐛 206 | 🌐 Jupyter Notebook | 📅 2024-06-10]
...
* RLHF \[[paper](https://huggingface.co/blog/rlhf)] \[[code](https://github.com/huggingface/blog/blob/main/zh/rlhf.md) ⭐ 3,515 | 🐛 249 | 🌐 Jupyter Notebook | 📅 2026-09-07]
...
* BIRD-SQL \[[paper](https://arxiv.org/pdf/2305.03111.pdf)] \[[code](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main/bird) ⭐ 1,594 | 🐛 80 | 🌐 Python | 📅 2026-06-10] \[[dataset](https://bird-bench.github.io/)]
...
* Spider 2.0 \[[paper](https://spider2-sql.github.io/)] \[[code](https://github.com/xlang-ai/Spider2) ⭐ 866 | 🐛 123 | 🌐 HTML | 📅 2026-08-12] \[[dataset](https://github.com/xlang-ai/Spider2) ⭐ 866 | 🐛 123 | 🌐 HTML | 📅 2026-08-12]
...
* CSpider \[[paper](https://arxiv.org/pdf/1909.13293.pdf)] \[[code](https://github.com/taolusi/chisp) ⭐ 204 | 🐛 8 | 🌐 Python | 📅 2021-03-12] \[[dataset](https://drive.google.com/drive/folders/1TxCUq1ydPuBdDdHF3MkHT-8zixluQuLa?usp=sharing)]
...
* BIRD-SQL Mini-Dev \[[paper](https://arxiv.org/pdf/2305.03111.pdf)] \[[code](https://github.com/bird-bench/mini_dev) ⭐ 183 | 🐛 16 | 🌐 Python | 📅 2026-09-05] \[[dataset](https://bird-bench.github.io/)]
...
* [QueryWeaver](https://github.com/FalkorDB/QueryWeaver) ⭐ 1,074 | 🐛 59 | 🌐 Python | 📅 2026-09-07
...
* [LLaMA-Efficient-Tuning](https://github.com/hiyouga/LLaMA-Efficient-Tuning) ⭐ 74,622 | 🐛 1,145 | 🌐 Python | 📅 2026-09-04
  [![GitHub Repo stars](https://img.shields.io/github/stars/hiyouga/LLaMA-Efficient-Tuning?style=social)](https://github.com/hiyouga/LLaMA-Efficient-Tuning/stargazers) ⭐ 74,622 | 🐛 1,145 | 🌐 Python | 📅 2026-09-04
...
* [Awesome-AIGC-Tutorials](https://github.com/luban-agi/Awesome-AIGC-Tutorials) ⭐ 4,539 | 🐛 10 | 📅 2024-03-31
  [![GitHub Repo stars](https://img.shields.io/github/stars/luban-agi/Awesome-AIGC-Tutorials?style=social)](https://github.com/luban-agi/Awesome-AIGC-Tutorials/stargazers) ⭐ 4,539 | 🐛 10 | 📅 2024-03-31
