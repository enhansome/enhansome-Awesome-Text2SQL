...
[![GitHub Repo stars](https://img.shields.io/github/stars/eosphoros-ai/Awesome-Text2SQL?style=social)](https://github.com/eosphoros-ai/Awesome-Text2SQL/) ⭐ 3,738 | 🐛 6 | 📅 2026-01-26
[![GitHub Repo forks](https://img.shields.io/github/forks/eosphoros-ai/Awesome-Text2SQL?style=social)](https://github.com/eosphoros-ai/Awesome-Text2SQL/) ⭐ 3,738 | 🐛 6 | 📅 2026-01-26
[![Awesome](https://img.shields.io/badge/Awesome-green.svg)](https://github.com/eosphoros-ai/Awesome-Text2SQL/) ⭐ 3,738 | 🐛 6 | 📅 2026-01-26
...
* (2025-TKDE, CCF-A) A Survey of Text-to-SQL in the Era of LLMs: Where are we, and where are we going?
  ...
  \[[code](https://github.com/HKUSTDial/NL2SQL_Handbook) ⭐ 1,566 | 🐛 0 | 🌐 Python | 📅 2026-07-28]
...
* (2025-TKDE, CCF-A) Next-Generation Database Interfaces: A Survey of LLM-based Text-to-SQL
  ...
  \[[code](https://github.com/DEEP-PolyU/Awesome-LLM-based-Text2SQL) ⭐ 1,356 | 🐛 0 | 📅 2026-08-03]
...
* (2023-arXiv, None) Can LLM Already Serve as A Database Interface? A BIg Bench for Large-Scale Database Grounded Text-to-SQLs
  ...
  \[[code](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main/bird) ⭐ 1,577 | 🐛 79 | 🌐 Python | 📅 2026-06-10]
...
* (2022-EMNLP, CCF-B) **STAR**: SQL Guided Pre-Training for Context-dependent Text-to-SQL Parsing
  ...
  \[[code](https://github.com/alibabaresearch/damo-convai) ⭐ 1,577 | 🐛 79 | 🌐 Python | 📅 2026-06-10]
...
* Llama \[[paper](https://arxiv.org/pdf/2302.13971.pdf)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,562 | 🐛 529 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
  * 2023/02, Meta AI proposes the open source LLM Llama, which has four scales: 7b, 13b, 33b, and 65b.

* Llama 2 \[[paper](https://ai.meta.com/research/publications/llama-2-open-foundation-and-fine-tuned-chat-models/)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,562 | 🐛 529 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
...
* ChatGLM \[[paper](https://arxiv.org/pdf/2103.10360.pdf)] \[[code](https://github.com/THUDM/ChatGLM-6B/blob/main/README.md) ⭐ 40,988 | 🐛 606 | 🌐 Python | 📅 2024-06-27] \[[model](https://huggingface.co/THUDM/chatglm-6b)]
  * 2023/03, Tsinghua University proposes the open bilingual language model ChatGLM, based on [General Language Model](https://github.com/THUDM/GLM) ⭐ 3,644 | 🐛 119 | 🌐 Python | 📅 2023-11-03 framework, with the specification of 7b.

* Vicuna \[[paper](https://lmsys.org/blog/2023-03-30-vicuna/)] \[[code](https://github.com/lm-sys/FastChat) ⭐ 39,511 | 🐛 1,039 | 🌐 Python | 📅 2026-05-01] \[[model](https://huggingface.co/lmsys)]
...
* Qwen-1.5-110B \[[paper](https://qwenlm.github.io/blog/qwen1.5-110b/)] \[[code](https://github.com/QwenLM/Qwen1.5) ⭐ 27,527 | 🐛 65 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen/Qwen1.5-110B)]
...
* Qwen2 \[[paper](https://qwenlm.github.io/blog/qwen2/)] \[[code](https://github.com/QwenLM/Qwen2) ⭐ 27,527 | 🐛 65 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/collections/Qwen/qwen2-6659360b33528ced941e557f)]
...
* Qwen2.5 \[[paper](https://arxiv.org/abs/2407.10671)] \[[code](https://github.com/QwenLM/Qwen2.5) ⭐ 27,527 | 🐛 65 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen)]
...
* Qwen \[[paper](https://qianwen-res.oss-cn-beijing.aliyuncs.com/QWEN_TECHNICAL_REPORT.pdf)] \[[code](https://github.com/QwenLM/Qwen) ⭐ 21,606 | 🐛 41 | 🌐 Python | 📅 2026-03-05] \[[model](https://huggingface.co/Qwen)]
...
* MiniCPM \[[paper](https://shengdinghu.notion.site/MiniCPM-c805a17c5c8046398914e47f0542095a)]
  \[[code](https://github.com/OpenBMB/MiniCPM) ⭐ 10,197 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-07-27]
...
* Deepseek \[[paper](https://arxiv.org/pdf/2401.02954.pdf)]
  \[[code](https://github.com/deepseek-ai/DeepSeek-LLM) ⭐ 7,243 | 🐛 58 | 🌐 Makefile | 📅 2024-02-04]
...
* InternLM \[[paper](https://github.com/InternLM/InternLM-techreport/blob/main/InternLM.pdf) ⭐ 893 | 🐛 6 | 📅 2023-06-07] \[[code](https://github.com/InternLM/InternLM/) ⭐ 7,266 | 🐛 8 | 🌐 Python | 📅 2025-10-30] \[[model](https://huggingface.co/internlm)]
...
* LoRA \[[paper](https://arxiv.org/pdf/2106.09685.pdf)] \[[code](https://github.com/microsoft/LoRA) ⭐ 13,745 | 🐛 113 | 🌐 Python | 📅 2024-12-17]
  * 2021/06, Microsoft proposes the Low-Rank Adaptation method for fine-tuning LLM by freezing the pre-training weights.

* QLoRA \[[paper](https://arxiv.org/pdf/2305.14314.pdf)] \[[code](https://github.com/artidoro/qlora) ⭐ 10,990 | 🐛 206 | 🌐 Jupyter Notebook | 📅 2024-06-10]
...
* RLHF \[[paper](https://huggingface.co/blog/rlhf)] \[[code](https://github.com/huggingface/blog/blob/main/zh/rlhf.md) ⭐ 3,497 | 🐛 249 | 🌐 Jupyter Notebook | 📅 2026-08-18]
...
* BIRD-SQL \[[paper](https://arxiv.org/pdf/2305.03111.pdf)] \[[code](https://github.com/AlibabaResearch/DAMO-ConvAI/tree/main/bird) ⭐ 1,577 | 🐛 79 | 🌐 Python | 📅 2026-06-10] \[[dataset](https://bird-bench.github.io/)]
...
* Spider 2.0 \[[paper](https://spider2-sql.github.io/)] \[[code](https://github.com/xlang-ai/Spider2) ⭐ 855 | 🐛 119 | 🌐 HTML | 📅 2026-08-12] \[[dataset](https://github.com/xlang-ai/Spider2) ⭐ 855 | 🐛 119 | 🌐 HTML | 📅 2026-08-12]
...
* BIRD-SQL Mini-Dev \[[paper](https://arxiv.org/pdf/2305.03111.pdf)] \[[code](https://github.com/bird-bench/mini_dev) ⭐ 179 | 🐛 8 | 🌐 Python | 📅 2025-11-06] \[[dataset](https://bird-bench.github.io/)]
...
* [QueryWeaver](https://github.com/FalkorDB/QueryWeaver) ⭐ 1,066 | 🐛 60 | 🌐 Python | 📅 2026-08-18
...
* [LLaMA-Efficient-Tuning](https://github.com/hiyouga/LLaMA-Efficient-Tuning) ⭐ 74,197 | 🐛 1,111 | 🌐 Python | 📅 2026-08-18
  [![GitHub Repo stars](https://img.shields.io/github/stars/hiyouga/LLaMA-Efficient-Tuning?style=social)](https://github.com/hiyouga/LLaMA-Efficient-Tuning/stargazers) ⭐ 74,197 | 🐛 1,111 | 🌐 Python | 📅 2026-08-18
