...
* (2025-TKDE, CCF-A) A Survey of Text-to-SQL in the Era of LLMs: Where are we, and where are we going?
  ...
  \[[code](https://github.com/HKUSTDial/NL2SQL_Handbook) ⭐ 1,577 | 🐛 0 | 🌐 Python | 📅 2026-07-28]
...
* Llama \[[paper](https://arxiv.org/pdf/2302.13971.pdf)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,581 | 🐛 531 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
  * 2023/02, Meta AI proposes the open source LLM Llama, which has four scales: 7b, 13b, 33b, and 65b.

* Llama 2 \[[paper](https://ai.meta.com/research/publications/llama-2-open-foundation-and-fine-tuned-chat-models/)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,581 | 🐛 531 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
...
* ChatGLM \[[paper](https://arxiv.org/pdf/2103.10360.pdf)] \[[code](https://github.com/THUDM/ChatGLM-6B/blob/main/README.md) ⭐ 40,984 | 🐛 605 | 🌐 Python | 📅 2024-06-27] \[[model](https://huggingface.co/THUDM/chatglm-6b)]
  * 2023/03, Tsinghua University proposes the open bilingual language model ChatGLM, based on [General Language Model](https://github.com/THUDM/GLM) ⭐ 3,654 | 🐛 119 | 🌐 Python | 📅 2023-11-03 framework, with the specification of 7b.

* Vicuna \[[paper](https://lmsys.org/blog/2023-03-30-vicuna/)] \[[code](https://github.com/lm-sys/FastChat) ⭐ 39,527 | 🐛 1,040 | 🌐 Python | 📅 2026-05-01] \[[model](https://huggingface.co/lmsys)]
...
* Alpaca \[[paper](https://crfm.stanford.edu/2023/03/13/alpaca.html)] \[[code](https://github.com/tatsu-lab/stanford_alpaca) ⭐ 30,247 | 🐛 186 | 🌐 Python | 📅 2024-07-17] \[[model](https://huggingface.co/tatsu-lab/alpaca-7b-wdiff/tree/main)]
...
* Qwen-1.5-110B \[[paper](https://qwenlm.github.io/blog/qwen1.5-110b/)] \[[code](https://github.com/QwenLM/Qwen1.5) ⭐ 27,565 | 🐛 65 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen/Qwen1.5-110B)]
...
* Qwen2 \[[paper](https://qwenlm.github.io/blog/qwen2/)] \[[code](https://github.com/QwenLM/Qwen2) ⭐ 27,565 | 🐛 65 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/collections/Qwen/qwen2-6659360b33528ced941e557f)]
...
* Qwen2.5 \[[paper](https://arxiv.org/abs/2407.10671)] \[[code](https://github.com/QwenLM/Qwen2.5) ⭐ 27,565 | 🐛 65 | 🌐 Python | 📅 2026-01-09] \[[model](https://huggingface.co/Qwen)]
...
* Qwen \[[paper](https://qianwen-res.oss-cn-beijing.aliyuncs.com/QWEN_TECHNICAL_REPORT.pdf)] \[[code](https://github.com/QwenLM/Qwen) ⭐ 21,664 | 🐛 37 | 🌐 Python | 📅 2026-03-05] \[[model](https://huggingface.co/Qwen)]
...
* MiniCPM \[[paper](https://shengdinghu.notion.site/MiniCPM-c805a17c5c8046398914e47f0542095a)]
  \[[code](https://github.com/OpenBMB/MiniCPM) ⭐ 10,262 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-07-27]
...
* Deepseek \[[paper](https://arxiv.org/pdf/2401.02954.pdf)]
  \[[code](https://github.com/deepseek-ai/DeepSeek-LLM) ⭐ 7,257 | 🐛 58 | 🌐 Makefile | 📅 2024-02-04]
...
* RLHF \[[paper](https://huggingface.co/blog/rlhf)] \[[code](https://github.com/huggingface/blog/blob/main/zh/rlhf.md) ⭐ 3,506 | 🐛 249 | 🌐 Jupyter Notebook | 📅 2026-08-26]
...
* [LLaMA-Efficient-Tuning](https://github.com/hiyouga/LLaMA-Efficient-Tuning) ⭐ 74,401 | 🐛 1,135 | 🌐 Python | 📅 2026-08-27
  [![GitHub Repo stars](https://img.shields.io/github/stars/hiyouga/LLaMA-Efficient-Tuning?style=social)](https://github.com/hiyouga/LLaMA-Efficient-Tuning/stargazers) ⭐ 74,401 | 🐛 1,135 | 🌐 Python | 📅 2026-08-27
