...
[![GitHub Repo stars](https://img.shields.io/github/stars/eosphoros-ai/Awesome-Text2SQL?style=social)](https://github.com/eosphoros-ai/Awesome-Text2SQL/) ⭐ 3,735 | 🐛 6 | 📅 2026-01-26
[![GitHub Repo forks](https://img.shields.io/github/forks/eosphoros-ai/Awesome-Text2SQL?style=social)](https://github.com/eosphoros-ai/Awesome-Text2SQL/) ⭐ 3,735 | 🐛 6 | 📅 2026-01-26
[![Awesome](https://img.shields.io/badge/Awesome-green.svg)](https://github.com/eosphoros-ai/Awesome-Text2SQL/) ⭐ 3,735 | 🐛 6 | 📅 2026-01-26
...
* (2025-TKDE, CCF-A) A Survey of Text-to-SQL in the Era of LLMs: Where are we, and where are we going?
  ...
  \[[code](https://github.com/HKUSTDial/NL2SQL_Handbook) ⭐ 1,561 | 🐛 0 | 🌐 Python | 📅 2026-07-28]
...
* (2025-TKDE, CCF-A) Next-Generation Database Interfaces: A Survey of LLM-based Text-to-SQL
  ...
  \[[code](https://github.com/DEEP-PolyU/Awesome-LLM-based-Text2SQL) ⭐ 1,353 | 🐛 0 | 📅 2026-08-03]
...
* Llama \[[paper](https://arxiv.org/pdf/2302.13971.pdf)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,558 | 🐛 528 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
  * 2023/02, Meta AI proposes the open source LLM Llama, which has four scales: 7b, 13b, 33b, and 65b.

* Llama 2 \[[paper](https://ai.meta.com/research/publications/llama-2-open-foundation-and-fine-tuned-chat-models/)] \[[code](https://github.com/facebookresearch/llama) ⭐ 59,558 | 🐛 528 | 🌐 Python | 📅 2025-01-26] \[[model](https://huggingface.co/meta-llama)]
...
* ChatGLM \[[paper](https://arxiv.org/pdf/2103.10360.pdf)] \[[code](https://github.com/THUDM/ChatGLM-6B/blob/main/README.md) ⭐ 40,987 | 🐛 607 | 🌐 Python | 📅 2024-06-27] \[[model](https://huggingface.co/THUDM/chatglm-6b)]
  * 2023/03, Tsinghua University proposes the open bilingual language model ChatGLM, based on [General Language Model](https://github.com/THUDM/GLM) ⭐ 3,638 | 🐛 120 | 🌐 Python | 📅 2023-11-03 framework, with the specification of 7b.

* Vicuna \[[paper](https://lmsys.org/blog/2023-03-30-vicuna/)] \[[code](https://github.com/lm-sys/FastChat) ⭐ 39,516 | 🐛 1,038 | 🌐 Python | 📅 2026-05-01] \[[model](https://huggingface.co/lmsys)]
...
* Alpaca \[[paper](https://crfm.stanford.edu/2023/03/13/alpaca.html)] \[[code](https://github.com/tatsu-lab/stanford_alpaca) ⭐ 30,244 | 🐛 187 | 🌐 Python | 📅 2024-07-17] \[[model](https://huggingface.co/tatsu-lab/alpaca-7b-wdiff/tree/main)]
...
* Qwen \[[paper](https://qianwen-res.oss-cn-beijing.aliyuncs.com/QWEN_TECHNICAL_REPORT.pdf)] \[[code](https://github.com/QwenLM/Qwen) ⭐ 21,583 | 🐛 43 | 🌐 Python | 📅 2026-03-05] \[[model](https://huggingface.co/Qwen)]
...
* MiniCPM \[[paper](https://shengdinghu.notion.site/MiniCPM-c805a17c5c8046398914e47f0542095a)]
  \[[code](https://github.com/OpenBMB/MiniCPM) ⭐ 10,172 | 🐛 19 | 🌐 Jupyter Notebook | 📅 2026-07-27]
...
* Deepseek \[[paper](https://arxiv.org/pdf/2401.02954.pdf)]
  \[[code](https://github.com/deepseek-ai/DeepSeek-LLM) ⭐ 7,230 | 🐛 58 | 🌐 Makefile | 📅 2024-02-04]
...
* Baichuan-7b \[[code](https://github.com/baichuan-inc/baichuan-7B) ⭐ 5,652 | 🐛 88 | 🌐 Python | 📅 2024-07-18] \[[model](https://huggingface.co/baichuan-inc/Baichuan-7B)]
...
* QLoRA \[[paper](https://arxiv.org/pdf/2305.14314.pdf)] \[[code](https://github.com/artidoro/qlora) ⭐ 10,989 | 🐛 206 | 🌐 Jupyter Notebook | 📅 2024-06-10]
...
* RLHF \[[paper](https://huggingface.co/blog/rlhf)] \[[code](https://github.com/huggingface/blog/blob/main/zh/rlhf.md) ⭐ 3,497 | 🐛 249 | 🌐 Jupyter Notebook | 📅 2026-08-14]
...
* [QueryWeaver](https://github.com/FalkorDB/QueryWeaver) ⭐ 1,064 | 🐛 58 | 🌐 Python | 📅 2026-08-13
...
* [LLaMA-Efficient-Tuning](https://github.com/hiyouga/LLaMA-Efficient-Tuning) ⭐ 74,087 | 🐛 1,113 | 🌐 Python | 📅 2026-08-13
  [![GitHub Repo stars](https://img.shields.io/github/stars/hiyouga/LLaMA-Efficient-Tuning?style=social)](https://github.com/hiyouga/LLaMA-Efficient-Tuning/stargazers) ⭐ 74,087 | 🐛 1,113 | 🌐 Python | 📅 2026-08-13
